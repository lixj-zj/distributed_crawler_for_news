...
parten = r'://(.*?)/' # 惰性匹配网址
print(re.findall(parten,url)[0])

WeChaturl = "https://mp.weixin.qq.com/s?__biz=MzAwMjk5Mjk3Mw==&mid=2247486108&idx=1&sn=b76d3805ce66ee5d7208fedcb2452667&chksm=9ac0b4beadb73da8c0271f69fc53970b578171f6cb0de3c47c4bcb3d9690ff73f2e1e4bfd23a&mpshare=1&scene=1&srcid=#rd"
parten1 =  r'//(.*?)/' # 惰性匹配网址
print(re.findall(parten1, WeChaturl))